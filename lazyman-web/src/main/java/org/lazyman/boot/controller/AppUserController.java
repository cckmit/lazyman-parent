...
public class AppUserController extends BaseController {
    ...
    @PutMapping(value = "/{id}")
    @Idempotency
    public ResultVO editWishUser(@ApiParam(value = "wish用户ID", required = true) @PathVariable(value = "id") Long id, @Valid @RequestBody AppUserFormDTO appUserFormDTO) {
    ...
    @GetMapping(value = "/{id}")
    public ResultVO<AppUserVO> getWishUserDetail(@ApiParam(value = "wish用户ID", required = true) @PathVariable(value = "id") Long id) {
